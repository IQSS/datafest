...
\tightlist
\item[Start]
\emph{examples/04\_htmlwidgets.R}
\item[Finished]
\emph{examples/04\_htmlwidgets\_finished.R}
\end{description}
\end{frame}

\begin{frame}{Exercise 4: Interactive storms map}
\protect\hypertarget{exercise-4-interactive-storms-map}{}
Open the exercise file: \emph{File \rightarrow Open File
\rightarrow exercises/04\_interactive\_storms\_map.R}
...
\tightlist
\item[Start]
\emph{examples/05\_layout\_appearance.R}
\item[Finished]
\emph{examples/05\_layout\_appearance\_finished.R}
\end{description}
\end{frame}

\begin{frame}[fragile]{Exercise 5: Spiff up the storms app}
\protect\hypertarget{exercise-5-spiff-up-the-storms-app}{}
Open the exercise file: \emph{File \rightarrow Open File
\rightarrow exercises/05\_storms\_pretty.R}
...
\begin{frame}{Workshop feedback}
\protect\hypertarget{workshop-feedback}{}
Help us make DataFest even better by giving us feedback at

\url{http://bit.ly/datafest_eval}
\end{frame}
