...
In the previous exercise we cleaned up the "top 100" boys names data. The Excel files
contain addiontal sheets, one of which contains *all* the boys names. 

Repeat the data cleaning process we used for the "top 100" data using the sheets 
containing all boys names. 
